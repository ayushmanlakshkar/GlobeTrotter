...
// Import Mapbox Map as an alternative
// import MapboxTripMap from '../components/mapbox-map';
      ...
      <div className="relative h-80 md:h-96 lg:h-[400px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full z-20 p-6 md:p-8 lg:p-12">
          <div className="container mx-auto">
            ...
            <p className="flex flex-wrap items-center text-white/90 gap-x-6 gap-y-2 [text-shadow:1px_1px_3px_rgb(0_0_0_/_0.5)]">
              {trip.description || "No description provided for this trip."}
            </p>

            <div className="flex flex-wrap items-center text-white/90 gap-x-6 gap-y-2 [text-shadow:1px_1px_3px_rgb(0_0_0_/_0.5)] mt-4">
        ...
        <div className="bg-white shadow-md rounded-xl p-4 md:p-6 mb-8 flex items-center justify-between">
          <div className="flex items-center">
            <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center text-primary font-bold text-lg mr-4">
              {trip.user.first_name[0]}
              {trip.user.last_name[0]}
            </div>
            <div>
              <h3 className="font-medium">
                Trip by {trip.user.first_name} {trip.user.last_name}
              </h3>
              <p className="text-sm text-gray-600">
                @{trip.user.username} • {trip.user.city}, {trip.user.country}
              </p>
            </div>
          </div>
          <div className="flex items-center">
                              ...
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  const regionImages = {
                                    ...
                                    London:
                                      "https://images.unsplash.com/photo-1505761671935-60b3a7427bad?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                                    ...
                                    Sydney:
                                      "https://images.unsplash.com/photo-1546268060-2592ff93ee24?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                                    Cairo:
                                      "https://images.unsplash.com/photo-1572252009286-268acec5ca0a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                                    Bangkok:
                                      "https://images.unsplash.com/photo-1508009603885-50cf7c8dd0d5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                                    Singapore:
                                  ...
                                  const cityImage = (regionImages as any)[
                                    stop.city.name
                                  ];
                                  e.currentTarget.src =
                                    cityImage ||
                              ...
                              <div className="absolute bottom-0 left-0 p-4 text-white">
                                <div className="flex items-center mb-1">
                                  ...
                                  <span className="text-xs opacity-75">
                                    {Math.round(
                                      (new Date(stop.end_date).getTime() -
                                        new Date(stop.start_date).getTime()) /
                                        (1000 * 60 * 60 * 24)
                                    ) + 1}{" "}
                                    days
                                  </span>
                                ...
                                <p className="text-sm opacity-90">
                                  ...
                                  {formatDate(stop.end_date)}
                                </p>
                                {/* City Cost Summary */}
                                {stop.tripActivities.some(
                                  (act) =>
                                    act.min_cost_override ||
                                    act.max_cost_override
                                ) && (
                                  <div className="mt-1">
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center">
                                          ...
                                          {(tripActivity.date ||
                                            ...
                                            <span className="bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded flex items-center">
                                              ...
                                              {tripActivity.date &&
                                                formatDate(tripActivity.date)}
                                              {tripActivity.time &&
                                                ` at ${tripActivity.time.substring(
                                                  0,
                                                  5
                                                )}`}
                                            </span>
                                      ...
                                      <div className="flex items-center mb-2">
                                        ...
                                        {(tripActivity.min_cost_override ||
                                          tripActivity.max_cost_override) && (
                                          <span className="ml-2 text-xs bg-green-50 text-green-700 px-2 py-1 rounded flex items-center">
                                            ...
                                            {tripActivity.min_cost_override &&
                                            tripActivity.max_cost_override
                                              ? `$${tripActivity.min_cost_override.toFixed(
                                                  2
                                                )} - $${tripActivity.max_cost_override.toFixed(
                                                  2
                                                )} per person`
                                              : tripActivity.min_cost_override
                                              ? `From $${tripActivity.min_cost_override.toFixed(
                                                  2
                                                )} per person`
                                              : `Up to $${tripActivity.max_cost_override.toFixed(
                                                  2
                                                )} per person`}
                                          </span>
                                        )}
                                      ...
                                      <div className="mt-3 h-32 rounded-md overflow-hidden">
                                        <img
                                          src={`https://source.unsplash.com/featured/?${tripActivity.activity.name.replace(
                                            /\s+/g,
                                            ","
                                          )}`}
                                          ...
                                          onError={(e) => {
                                            ...
                                            > = {
                                              ...
                                              culture:
                                                "https://images.unsplash.com/photo-1551963831-b3b1ca40c98e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                                              landmark:
                                              ...
                                              activity:
                                                "https://images.unsplash.com/photo-1527856263669-12c3a0af2aa6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                                            };
          ...
          <div className="space-y-6">
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-4 text-center">
                <p className="text-sm text-gray-500 mb-2">
                  Weather forecast for your destinations
                </p>
            ...
            <Card className="overflow-hidden">
              ...
              <div className="rounded-lg overflow-hidden border border-gray-200">
                  <TripMap tripStops={trip.tripStops} height="400px" />
                </div>
